...
\begin{lec}{January 2022}
  ...
  \begin{step}[2]
    Factor all of $A(x),B(x),C(x),D(x)$, then \textbf{rewrite} the expression.
  \end{step}
  ...
  \begin{ex}
    ...
    \item
      \[
        \frac{x^2 - 3x - 18}{2x^2 + 5x - 3}
      .\] 

      \item \[
            \frac{4x^2}{3x} \times \frac{12x^3}{2x}
      .\] 

    \item \[
          \frac{2x^2 - 8x}{x^2 - 3x - 10} \div \frac{4x^2}{x^2 - 9x + 20}
    .\] 
    \end{enumerate}
  ...
  \begin{ex}
    Let $P(x) = 5x-10$ and  $R(x) = 10x$. Determine $\gcd \left( P(x), R(x) \right) $.
  \end{ex}

  \begin{ex}
    Let $A(x) = x^2 - 4x + 3$ and  $B(x) = 2x^2 - 7x + 3$. Determine $\gcd \left( A(x), B(x) \right) $.
  \end{ex}
  ...
  \begin{step}[2]
    Determine the LCD, 
    \[
        \textcolor{blue}{L(x)} = \frac{B(x)\cdot D(x)}{\gcd \left( B(x),D(x) \right) }
    .\] 
  \end{step}
  
  \begin{step}[3]
    Determine the \textit{adjustment factors},
    \[
          \textcolor{red}{R(x)} = \frac{L(x)}{B(x)} \hspace*{1cm} \textcolor{violet}{Q(x)} = \frac{L(x)}{D(x)}
    .\] 
  \end{step}
  ...
  \begin{step}[4]
    ...
    \[
        \frac{A(x)\cdot \textcolor{red}{R(x)} \pm  C(x) \cdot \textcolor{violet}{Q(x)}}{\textcolor{blue}{L(x)}}
    .\] 
  \end{step}
  ...
  \begin{ex}
    ...
    \item \[
      \frac{x + 9}{x^2 + 2x - 48} - \frac{x - 9}{x^2 - x - 30}
  .\] 
